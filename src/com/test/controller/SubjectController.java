	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("insert") != null) {
			...
			try {
				...
				if (lc.delete(subid)) {
					session.setAttribute("mess", "Successfully Deleted.");// use
																			// this
																			// attribute
																			// to
																			// abstract
			...
			try {
				...
				if (sub != null) {
					session.setAttribute("subjectDisplay", sub);// use this
																// attribute to
																// display data
			...
			try {
				if (lc.update(subid, sub)) {
					session.setAttribute("mess", "Successfully Updated.");// use
																			// this
																			// attribute
																			// to
																			// abstract
			...
			try {
				...
				if (sub != null) {
					request.setAttribute("subjectName", sub);// use this
																// attribute to
																// display data
					RequestDispatcher dispatch = request.getRequestDispatcher("./subject.jsp");
					dispatch.forward(request, response);
